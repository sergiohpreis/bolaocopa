		...
		r.Group(func(r chi.Router) {
			...
			r.Route("/boloes", func(r chi.Router) {
				...
				r.Route("/{id}", func(r chi.Router) {
					...
					r.Put("/palpites/{jogoId}/retroativo", palpite.UpsertRetroativo)
					r.Route("/palpites/{palpiteId}", func(r chi.Router) {
						r.Post("/aprovar", palpite.Aprovar)
						r.Post("/rejeitar", palpite.Rejeitar)
					})
